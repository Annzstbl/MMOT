...
from mmot.loss.loss import l1_loss_rotate, loss_rotated_iou_norm_bboxes1
from mmot.util.dist import box_iou_rotated_norm_bboxes1
from mmot.mmlab.hs_mmrotate import obb2poly
from mmot.datasets.pipelines.channel import rotate_norm_boxes_to_boxes
