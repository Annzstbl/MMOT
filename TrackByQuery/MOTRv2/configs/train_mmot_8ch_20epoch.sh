...
PRETRAIN=$ROOT/weights//r50_deformable_detr_plus_iterative_bbox_refinement-checkpoint_8ch3d.pth
EXP_DIR=$ROOT/exp/motrv2/train_8ch-3D
#TODO
DET_DB=$PWD/train.json 
