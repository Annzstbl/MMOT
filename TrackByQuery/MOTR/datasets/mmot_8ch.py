...
from mmot.datasets.pipelines.compose import MotCompose
from mmot.datasets.pipelines.channel import MotrToMmrotate, MmrotateToMotr
from mmot.datasets.pipelines.loading import MotLoadAnnotations, MotLoadImageFromFile, MotLoadMultichannelImageFromNpy
...
def build_dataset2transform(args, image_set):
    ...
    mmot_test = make_transforms_for_mmot_rgb('val', args)

    # dataset2transform_train = {'mmot_RGB': mmot_train}
    # dataset2transform_val = {'mmot_RGB': mmot_test}
    if image_set == 'train':
        return mmot_train
    elif image_set == 'val':
        return mmot_test
...
def build(image_set, args):
    ...
    if image_set == 'train':
        ...
        dataset = DetmmotDetection(args, data_txt_path=data_txt_path, seqs_folder=root, dataset2transform=dataset2transform, block_cat=args.block_cat, block_trunc=args.block_trunc, vid_white_list=args.vid_white_list)
    if image_set == 'val':
...
def make_transforms_for_mmot_rgb(image_set, args=None):
    ...
    if image_set == 'train':
        return MotCompose([
            ...
            # MotShow(save_path='/data/users/litianhao/mmot_code/workdir/debug/MotShow',to_bgr=False, img_name_tail='ori'),
            ...
            # MotShow(save_path='/data/users/litianhao/mmot_code/workdir/debug/MotShow',to_bgr=False, img_name_tail='randomcrop'),
            ...
            # MotShow(save_path='/data/users/litianhao/mmot_code/workdir/motr/debug', version='le135', mean=[125,125,125,125,125,125,125,125,], std=[125,125,125,125,125,125,125,125,], to_bgr=False, img_name_tail='afterpad'),
