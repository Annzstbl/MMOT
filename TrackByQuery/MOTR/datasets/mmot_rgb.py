...
from mmot.datasets.pipelines.loading import MotLoadAnnotations, MotLoadImageFromFile
...
def make_transforms_for_mmot_rgb(image_set, args=None):
    ...
    if image_set == 'train':
        return MotCompose([
            ...
            # MotShow(save_path='/data/users/litianhao/mmot_code/workdir/debug/MotShow', version='le135', mean=[66.04, 69.87, 61.45], std=[36.46, 35.70, 34.93]),
