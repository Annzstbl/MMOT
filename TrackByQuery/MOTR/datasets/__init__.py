...
from .mmot_rgb import build as build_e2e_mmot_rgb
from .mmot_8ch import build as build_e2e_mmot_8ch
from .mmot_8ch_1seq import build as build_e2e_mmot_8ch_1seq
...
def build_dataset(image_set, args):
    ...
    if args.dataset_file == 'e2e_mmot_rgb':
        return build_e2e_mmot_rgb(image_set, args)
    if args.dataset_file == 'e2e_mmot_8ch':
        return build_e2e_mmot_8ch(image_set, args)
