...
import math
from mmot.datasets.pipelines.channel import version_index_to_str
...
def loss_rotated_iou_norm_bboxes1(bboxes1: torch.Tensor,
    ...
    assert True, "Should use mmot.loss.loss_rotated_iou_norm_bboxes1 instead of mmot.util.loss.loss_rotated_iou_norm_bboxes1"
