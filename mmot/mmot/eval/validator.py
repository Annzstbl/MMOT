...
if __name__ == "__main__":
    lines = val_folder('/data/users/litianhao/data/mmot/test/mot', '/data3/litianhao/mmot/motip_99/joint_10lrconv_distill/track1/submit')
    print('\n'.join(lines))
    # from mmot.mmlab.hs_mmrotate import poly2obb, obb2poly

    # # 以文件尝试
    # gt_txt = '/data/users/litianhao/data/mmot/test/mot/data30-10.txt'
    # # pred_txt = '/data3/litianhao/mmot/motip/pretrain_10lrfconv_distill/train/eval_during_train/test/epoch_1/submit/data30-10.txt'
    # pred_txt = '/data3/litianhao/mmot/motip_99/joint_10lrconv_distill/track1/submit/data30-10.txt'
