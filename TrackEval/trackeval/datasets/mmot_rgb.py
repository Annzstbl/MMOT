...
class mmot_RGB(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            'GT_FOLDER': '/data3/PublicDataset/Custom/mmot/test/mot',  # Location of GT data
            'IMG_FOLDER': '/data3/PublicDataset/Custom/mmot/test/rgb',  #图像目录
            'TRACKERS_FOLDER': '/data3/litianhao/workdir/mmot',  # Trackers location
