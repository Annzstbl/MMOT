...
if __name__ == "__main__":
    ...
    '''
        python mmot/predict_normal.py /data/users/litianhao/data/mmot/train/npy /data/users/litianhao/mmot_code/workdir/yolo11/predict_trainset_yolov11l_8ch_CocoPretrain_CopyFirstConv_imgsize1280_4gpu /data/users/litianhao/mmot_code/workdir/yolo11/yolov11l_8ch_CocoPretrain_CopyFirstConv_imgsize1280_4gpu/weights/best.pt
    '''
